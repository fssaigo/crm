 ...
 * Generated for Laravel 5.3.6 on 2016-11-02.
 *
...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \App\Http\Repositories\Eloquent\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \App\Http\Repositories\Eloquent\User|false 
         * @static 
         */
         ...
         *
         * @return \App\Http\Repositories\Eloquent\User 
         * @static 
         */
